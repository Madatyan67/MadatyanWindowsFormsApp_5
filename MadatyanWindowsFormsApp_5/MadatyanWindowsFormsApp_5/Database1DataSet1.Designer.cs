...
namespace WindowsFormsApp5 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id_user, string login, string password, int telephone) {
...
namespace WindowsFormsApp5.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id_user] = @Original_Id_user) AND ((@IsNull_login = 1 AND [login] IS NULL) OR ([login] = @Original_login)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_telephone = 1 AND [telephone] IS NULL) OR ([telephone] = @Original_telephone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id_user], [login], [password], [telephone]) VALUES (@" +
                "Id_user, @login, @password, @telephone);\r\nSELECT Id_user, login, password, telep" +
                "hone FROM [Table] WHERE (Id_user = @Id_user)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id_user] = @Id_user, [login] = @login, [password] = @password, [telephone] = @telephone WHERE (([Id_user] = @Original_Id_user) AND ((@IsNull_login = 1 AND [login] IS NULL) OR ([login] = @Original_login)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_telephone = 1 AND [telephone] IS NULL) OR ([telephone] = @Original_telephone)));
SELECT Id_user, login, password, telephone FROM [Table] WHERE (Id_user = @Id_user)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_user, login, password, telephone FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id_user, string Original_login, string Original_password, global::System.Nullable<int> Original_telephone) {
        ...
        public virtual int Insert(int Id_user, string login, string password, global::System.Nullable<int> telephone) {
        ...
        public virtual int Update(int Id_user, string login, string password, global::System.Nullable<int> telephone, int Original_Id_user, string Original_login, string Original_password, global::System.Nullable<int> Original_telephone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string password, global::System.Nullable<int> telephone, int Original_Id_user, string Original_login, string Original_password, global::System.Nullable<int> Original_telephone) {
            return this.Update(Original_Id_user, login, password, telephone, Original_Id_user, Original_login, Original_password, Original_telephone);
        }
    }
